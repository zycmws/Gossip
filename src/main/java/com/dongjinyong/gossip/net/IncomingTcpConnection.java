...
public class IncomingTcpConnection extends Thread {
   ...
   * bypasses the InputStream implementations to use sendFile, we cannot begin buffering until we've
...
//                    System.out.println("receive message,doVerb. Message type:"+verb+",message len:"+bodySize+",message from:"+message.getFrom());
          ...
          logger.debug("Received connection from newer protocol version {}. Ignoring message",
              version);
        }
