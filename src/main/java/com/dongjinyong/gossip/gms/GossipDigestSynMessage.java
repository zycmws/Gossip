...
class EndpointStatesSerializationHelper {
  ...
  private static final Logger logger_ = LoggerFactory
      .getLogger(EndpointStatesSerializationHelper.class);

  static void serialize(Map<InetSocketAddress, EndpointState> epStateMap, DataOutput dos)
      throws IOException {
  ...
  static Map<InetSocketAddress, EndpointState> deserialize(DataInput dis) throws IOException {
    int size = dis.readInt();
    Map<InetSocketAddress, EndpointState> epStateMap = new HashMap<InetSocketAddress, EndpointState>(
        size);
...
class GossipDigestSynMessageSerializer implements IVersionedSerializer<GossipDigestSynMessage> {
  ...
  public void serialize(GossipDigestSynMessage gDigestSynMessage, DataOutput dos)
      throws IOException {
