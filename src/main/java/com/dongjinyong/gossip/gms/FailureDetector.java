 ...
 */
  ...
  public String getAllEndpointStates() {
    ...
    for (Map.Entry<InetSocketAddress, EndpointState> entry : Gossiper.instance.endpointStateMap
        .entrySet()) {
  ...
  public Map<String, String> getSimpleStates() {
    Map<String, String> nodesStatus = new HashMap<String, String>(
        Gossiper.instance.endpointStateMap.size());
    for (Map.Entry<InetSocketAddress, EndpointState> entry : Gossiper.instance.endpointStateMap
        .entrySet()) {
  ...
  public String getEndpointState(String address) throws UnknownHostException {
    StringBuilder sb = new StringBuilder();
    EndpointState endpointState = Gossiper.instance
        .getEndpointStateForEndpoint(InetSocketAddressUtil.parseInetSocketAddress(address));
  ...
  private void appendEndpointState(StringBuilder sb, EndpointState endpointState) {
    for (Map.Entry<ApplicationState, VersionedValue> state : endpointState.applicationState
        .entrySet()) {
      sb.append("  ").append(state.getKey()).append(":").append(state.getValue().value)
          .append("\n");
    }
  }
