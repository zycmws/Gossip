...
class GossipDigestAckMessage {
  ...
  GossipDigestAckMessage(List<GossipDigest> gDigestList,
      Map<InetSocketAddress, EndpointState> epStateMap) {
...
class GossipDigestAckMessageSerializer implements IVersionedSerializer<GossipDigestAckMessage> {
  ...
  public void serialize(GossipDigestAckMessage gDigestAckMessage, DataOutput dos)
      throws IOException {
  ...
  public GossipDigestAckMessage deserialize(DataInput dis) throws IOException {
    ...
    Map<InetSocketAddress, EndpointState> epStateMap = EndpointStatesSerializationHelper
        .deserialize(dis);
